...
private final By postConfirmationText = By.xpath("//p[text()='Test1234']");
...
public void clickSavePostButton() {
    ...
    return driverWait().until(ExpectedConditions.visibilityOfElementLocated(postConfirmationText)).getText();
    }
}
